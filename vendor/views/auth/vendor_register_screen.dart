...
import 'package:kofi_multi_store/vendor/controllers/vendor_register_controller.dart';
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Please Email Address Must Not Be Emppty';
                      } else {
                        return null;
                      }
                    },
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Please Phone Number Must Not Be Emppty';
                      } else {
                        return null;
                      }
                    },
                  ...
                  if (_taxStatus == 'YES')
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        validator: (value) {
                          if (value!.isEmpty) {
                            return 'Please Tax Number Must Not Be Emppty';
                          } else {
                            return null;
                          }
                        },
